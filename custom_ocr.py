...
Original file is located at
    https://colab.research.google.com/drive/1NsQvgarPb8Eny15CfKatoZ3Wjr5U5Rrx
...
data = np.vstack([digits_data, alphabet_data])
labels = np.hstack([digits_labels, alphabet_labels])
...
plt.title('Class : ' + str(labels[30000]))
...
checkpointer = ModelCheckpoint(file_model+ ".keras",monitor='val_loss', verbose=1, save_best_only=True)

history = network.fit(augumentation.flow(X_train, y_train, batch_size=batch_size),
...
"""Saving the neural network on drive"""
...
!cp network.keras /content/drive/MyDrive/Model/network.keras
...
loaded_network = load_model('/content/drive/MyDrive/Model/network.keras')

loaded_network

loaded_network.summary()

img = cv2.imread('/content/drive/MyDrive/OCR_1/OCR with Python/Images/Images/letter-m.jpg')
cv2_imshow(img)
